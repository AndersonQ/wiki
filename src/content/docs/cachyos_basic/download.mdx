...
**Current ISO Version:** `260426`

**SHA256 Hash:** `9a280d1e9732cfe50ab02db6a7e44ae0d9e6a10e6ea394f73192f7c14e263118`
...
1. Download the [file](https://mirror.cachyos.org/ISO/desktop/260426/cachyos-desktop-linux-260426.iso.sha256) containing the SHA256 hash **(Open it with a text editor, e.g., Notepad)**.
...
1. Download the [file](https://mirror.cachyos.org/ISO/desktop/260426/cachyos-desktop-linux-260426.iso.sha256) containing the SHA256 hash.
...
2. Download the ISO file and its [.sig](https://cdn77.cachyos.org/ISO/desktop/260426/cachyos-desktop-linux-260426.iso.sig) signature file and run the following command (replace `full_iso_name.iso` with the actual ISO filename):
   ```shell
   gpg --verify cachyos-desktop-linux-260426.iso.sig cachyos-desktop-linux-260426.iso
   ```
